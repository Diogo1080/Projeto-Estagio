			...
			<div class="card" style=" margin-top:25px;">
				...
				<div id="enc_edu_atleta" style="display: none">
					...
					<!--Form secundario-->
						...
						<div>
							<label>Nome:</label>
								<input id="nome_contribuinte_enc" class="input_enc required" name="nome_enc" onkeyup="return soletras(this)" value="<?php 
										if ((isset($_GET['id_contribuinte'])) AND ($linha['tipo_contribuinte']=="Atleta")) {
											echo($linha_enc['nome']);
										}elseif (isset($_POST['insert']) || isset($_POST['update'])){
											echo($_POST['nome_enc']);
						...
						<div>
							<label>CC:</label>
								<input id="cc_contribuinte_enc" class="input_enc required" maxlength="9" name="cc_enc" onkeyup="return sonumeros(this)" value="<?php 
										if ((isset($_GET['id_contribuinte'])) AND ($linha['tipo_contribuinte']=="Atleta")) {
											echo($linha_enc['cc']);
										}elseif (isset($_POST['insert']) || isset($_POST['update'])){
											echo($_POST['cc_enc']);
						...
						<div>
							<label>NIF:</label>
								<input id="nif_contribuinte_enc" class="input_enc required" maxlength="9" name="nif_enc" onkeyup="return sonumeros(this)" value="<?php 
										if ((isset($_GET['id_contribuinte'])) AND ($linha['tipo_contribuinte']=="Atleta")) {
											echo($linha_enc['nif']);
										}elseif (isset($_POST['insert']) || isset($_POST['update'])){
											echo($_POST['nif_enc']);
						...
						<div>
							<label>Morada:</label>
								<input id="morada_contribuinte_enc" class="input_enc required" name="morada_enc" onkeyup="return moradacheck(this)" value="<?php 
										if ((isset($_GET['id_contribuinte'])) AND ($linha['tipo_contribuinte']=="Atleta")) {
						...
						<div>
							<label>Localidade:</label>
								<input id="localidade_contribuinte_enc" class="input_enc required" name="localidade_enc" onkeyup="return soletras(this)" value="<?php 
										if ((isset($_GET['id_contribuinte'])) AND ($linha['tipo_contribuinte']=="Atleta")) {
						...
						<div>
							<label>Freguesia:</label>
								<input id="freguesia_contribuinte_enc" class="input_enc required" name="freguesia_enc" onkeyup="return soletras(this)" value="<?php 
										if ((isset($_GET['id_contribuinte'])) AND ($linha['tipo_contribuinte']=="Atleta")) {
						...
						<div>
							<label>Concelho:</label>
								<input id="concelho_contribuinte_enc" class="input_enc required" name="concelho_enc" onkeyup="return soletras(this)" value="<?php 
										if ((isset($_GET['id_contribuinte'])) AND ($linha['tipo_contribuinte']=="Atleta")) {
						...
						<div>
							<label>CP:</label>
								<input id="cp_contribuinte_enc" maxlength="8" class="input_enc required" maxlength="7"  name="cp_enc" onkeyup="return codigo_postalcheck(this)" value="<?php 
										if ((isset($_GET['id_contribuinte'])) AND ($linha['tipo_contribuinte']=="Atleta")) {
											echo($linha_enc['cp']);
										}elseif (isset($_POST['insert']) || isset($_POST['update'])){
											echo($_POST['cp_enc']);
						...
						<div>
							<label>Email:</label>
								<input id="email_contribuinte_enc" class="input_enc required" name="email_enc" onkeyup="return emailcheck(this)" value="<?php 
										if ((isset($_GET['id_contribuinte'])) AND ($linha['tipo_contribuinte']=="Atleta")) {
						...
						<div>
							<label>Telemovel:</label>
								<input id="telemovel_contribuinte_enc" class="input_enc required" name="telemovel_enc" onkeyup="return telemovelcheck(this)" value="<?php 
										if ((isset($_GET['id_contribuinte'])) AND ($linha['tipo_contribuinte']=="Atleta")) {
						...
						<div>
							<label>Telefone:</label>
								<input id="telefone_contribuinte_enc" class="input_enc required" maxlength="9" name="telefone_enc" onkeyup="return telemovelcheck(this)" value="<?php 
										if ((isset($_GET['id_contribuinte'])) AND ($linha['tipo_contribuinte']=="Atleta")) {
